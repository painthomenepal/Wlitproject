...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap;
        mMap.addMarker(new MarkerOptions().position(new LatLng(27.657905, 85.321447))
                .title("Ringroad, Patan").snippet("EVEREST BANK ATM"));
        mMap.addMarker(new MarkerOptions().position(new LatLng(27.735463, 85.334093))
                .title("Maharajgung,Kathmandu").snippet("EVEREST BANK ATM"));
        mMap.addMarker(new MarkerOptions().position(new LatLng(27.687441, 85.333586))
                .title("MadanBhandari,Kathmandu").snippet("EVEREST BANK ATM"));
    }
